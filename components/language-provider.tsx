...
const translations = {
  es: {
    ...
    "login_msg": "Para ver y guardar tus personajes en la nube, necesitamos reconectar con tu cuenta de Google.",
    "no_characters": "No hay personajes",
    "no_characters_cloud": "No se encontraron personajes en tu Drive.",
    "no_characters_local": "Crea tu primer investigador para comenzar tu aventura",
    ...
    "how_to_proceed_desc": "Puedes tirar los dados para determinar si la habilidad mejora, o introducir manualmente el resultado.",
    ...
    "check_d100_desc_high": "Tu habilidad es muy alta (>=95). Solo mejorarás si sacas entre 96 y 100.",
    "check_d100_desc_normal": "Necesitas sacar más de {value} en el d100 para mejorar.",
  ...
  en: {
    ...
    "how_to_proceed_desc": "You can roll the dice to see if the skill improves, or enter the result manually.",
